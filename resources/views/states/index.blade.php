...
@section('content')
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"> States  </h1><br/><br/>
        </div>
        ...
        <div class="card mx-auto">
                ...
                <form method="GET" action="{{ route('states.index') }}">
                        ...
                        <input type="search" name="search" class="form-control mb-2" id="inlineFormInput" placeholder="User">
                        </div>
                ...
                <table class="table">
                        ...
                        <td>{{ $state->name }}</td>
                        <td>
                                <a href="{{ route('states.edit', $state->id) }}" class="btn btn-success"><i class="far fa-edit"></i>
